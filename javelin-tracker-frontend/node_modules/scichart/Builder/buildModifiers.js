...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarCursor, function (options) { return new PolarCursorModifier_1.PolarCursorModifier(options); }, true);
...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarDataPointSelection, function (options) { return new PolarDataPointSelectionModifier_1.PolarDataPointSelectionModifier(options); }, true);
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarSeriesSelection, function (options) { return new PolarSeriesSelectionModifier_1.PolarSeriesSelectionModifier(options); }, true);
...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarMouseWheelZoom, function (options) { return new PolarMouseWheelZoomModifier_1.PolarMouseWheelZoomModifier(options); }, true);
...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarArcZoom, function (options) { return new PolarArcZoomModifier_1.PolarArcZoomModifier(options); }, true);
...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarZoomExtents, function (options) { return new PolarZoomExtentsModifier_1.PolarZoomExtentsModifier(options); }, true);
...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarPan, function (options) { return new PolarPanModifier_1.PolarPanModifier(options); }, true);
...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart2DModifier, ChartModifierType_1.EChart2DModifierType.PolarLegend, function (options) { return new PolarLegendModifier_1.PolarLegendModifier(options); }, true);
/**
...
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart3DModifier, ChartModifierType_1.EChart3DModifierType.MouseWheelZoom, function (options) { return new MouseWheelZoomModifier3D_1.MouseWheelZoomModifier3D(options); }, true);
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart3DModifier, ChartModifierType_1.EChart3DModifierType.Orbit, function (options) { return new OrbitModifier3D_1.OrbitModifier3D(options); }, true);
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart3DModifier, ChartModifierType_1.EChart3DModifierType.PinchZoom, function (options) { return new PinchZoomModifier3D_1.PinchZoomModifier3D(options); }, true);
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart3DModifier, ChartModifierType_1.EChart3DModifierType.Tooltip, function (options) { return new TooltipModifier3D_1.TooltipModifier3D(options); }, true);
(0, classFactory_1.registerType)(BaseType_1.EBaseType.Chart3DModifier, ChartModifierType_1.EChart3DModifierType.ZoomExtents, function (options) { return new ResetCamera3DModifier_1.ResetCamera3DModifier(options); }, true);
/**
 ...
 * @returns An array of modifiers
 */
var buildModifiers3D = function (definition) {
    if (typeof definition === "string") {
        definition = JSON.parse(definition, chartBuilder_1.chartReviver);
    }
    var modifiers = [];
...
var buildModifier3D = function (definition) {
